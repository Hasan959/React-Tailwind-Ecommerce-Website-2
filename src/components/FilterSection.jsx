  ...
  return (
    ...
    <div className='bg-gray-100 mt-10 p-4 rounded-md h-max '>
        ...
        <div>
          ...
          <input type="range" min='0' max='200' name='' id='' value={priceRange[1]} onChange={(e)=>setPriceRange([priceRange[0],Number(e.target.value )])}/>
          
        </div>
        
        <button className='bg-red-500 text-white rounded-md px-3 py-1 mt-5 cursor-pointer'onClick={()=>{setSearch('');setCategory('All'); setBrand('All'); setPriceRange([0,200])} } > Reset Filters </button>
